...
- [Data sharing as a new component of addressing and preparing for disease outbreaks](SciDataCon-2018-data-sharing.md)
  ...
  - We will look at some of the examples presented in there from the perspective of generalizing from (past) disease outbreaks to (past) disasters more generally and how that can inform future data-related activities in disaster contexts.
