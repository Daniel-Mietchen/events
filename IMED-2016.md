*[About](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#about)・[Abstract](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#abstract)・[Questions](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#questions)・[See also](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#see-also)*

# Data sharing in public health emergencies
[1854: Cholera](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#1854-cholera-london)・[2005: H5N1](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#global-spread-of-h5n1-in-2005)・[2005: Hurricane Katrina](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#hurricane-katrina-2005)・[2009: H1N1](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#2009-h1n1-pandemic)・[2010: Haiti earthquake](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#2010-haiti-earthquake)・[2011: Tōhoku earthquake](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#2011-t%C5%8Dhoku-earthquake-and-tsunami)・[2011: E. coli O104:H4](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#2011-e-coli-o104h4-outbreak)・[2013: Typhoon Hiyan](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#typhoon-haiyan-2013)・[2015: Ebola](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#ebola-virus-epidemic-in-west-africa)・[2016: Zika](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#zika-virus-outbreak)・[Future?](https://github.com/Daniel-Mietchen/talks/blob/master/IMED-2016.md#future)
...
# Questions?
* Feel free to post them [on GitHub](https://github.com/Daniel-Mietchen/talks/issues) or [via Twitter](https://twitter.com/EvoMRI).

# About
This file hosts my "slide" for a talk for the [International Meeting on Emerging Diseases and Surveillance (IMED 2016)](http://imed.isid.org/), which took place on 4-7 November, 2016, in Vienna, Austria. It was submitted as an abstract to the "Public communication of outbreaks and emerging diseases" track on July 10 and received the abstract number 1124 in their system. On August 17, the abstract was accepted for the poster session. Upon confirming my attendance on September 16, I requested whether this contribution could be turned into a talk, and this was granted on September 18.

The talk then became part of the session "[Innovative Approaches to Emerging Disease Surveillance](http://imed.isid.org/downloads/FinalProgram.pdf)" at 8.30-10.30am on Monday, November 7, in Room Klimt 2&3.
...
* ["Due to an effective quarantine policy, most Danish cities experienced only a single [Cholera] epidemic in 1853 and detailed data are available."](http://www.abstractsonline.com/pp8/#!/4114/presentation/5281)
